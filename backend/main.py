...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        # NOTE: Do NOT auto-create default streamer.
        # In production, all streamers must be real users who authenticate via signup.
        # This prevents demo data from polluting production databases.
